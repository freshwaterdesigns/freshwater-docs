...
- **Multi Column (FW) & Hero Carousel (FW) — section schema labels:** Device toggles in the carousel and block groups now use concise **Desktop** / **Mobile** labels under explicit **CAROUSEL** and **BLOCK** headings, separated by square dividers (**■**) for quicker scanning in the theme editor.
